...
import { AdminApiSeriesApiClient, PostInListDTOPageResult, SeriesDTO, SeriesInListDTO, SeriesInListDTOPageResult } from '../../../api/admin-api.service.generated';
...
export class SeriesComponent implements OnInit, OnDestroy {
  ...
  loadData(selectionId = null) {
    ...
    this.seriesApiClient.getSeriesPaging(this.keyword, this.pageIndex, this.pageSize)
      ...
      .subscribe({
        next: (response: SeriesInListDTOPageResult) => {
