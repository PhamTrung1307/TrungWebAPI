...
namespace API.Controllers.AdminAPI
{
    ...
    public class PostController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("paging")]
        public async Task<ActionResult<PageResult<PostDTO>>> GetPagedPostsAsync(string? key, Guid? categoryID, int pageIndex, int pageSize)
        {
            var result = await _unitOfWork.Posts.GetPagedPostsAsync(key, categoryID, pageIndex, pageSize);
            return Ok(result);
